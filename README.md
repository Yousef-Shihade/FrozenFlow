...
a trustworthy point of comparison, which is what Stage 1 builds.

| Stage | Topic | Status |
| --- | --- | --- |
| **1** | **Classification baselines with frozen encoders** — linear probe + image-derived prototypes | **complete** |
| 2 | Flow Matching as the *last* layer (standard vs. rolled-out training) | not started |
...
Open any notebook under `Stage_1/Work/*/code/` in VS Code, select the kernel
